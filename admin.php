...
if (isset($_POST['submit_post'])) {
    // Debug information
    error_log("Post form submitted in admin.php: " . print_r($_POST, true));
...
<div class="row mb-4">
    <?php
    // Get stats
    $total_published = count_posts(['status' => 'published']);
    $total_drafts = count_posts(['status' => 'draft']);
                    ...
                    <?php if (!empty($posts)): ?>
                        <?php foreach ($posts as $index => $post): ?>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge bg-<?php echo $post['post_status'] == 'published' ? 'success' : 'warning'; ?>">
